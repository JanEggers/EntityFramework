...
namespace Microsoft.EntityFrameworkCore
{
    ...
    /// </summary>
    public static class CsvDatabaseFacadeExtensions
    {
        /// <summary>
        ///     <para>
        ...
        public static bool IsCsv([NotNull] this DatabaseFacade database)
            => database.ProviderName.Equals(
                typeof(CsvOptionsExtension).GetTypeInfo().Assembly.GetName().Name,
