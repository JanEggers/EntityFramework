...
namespace Microsoft.EntityFrameworkCore.Csv.Storage.Internal
{
    ...
    /// </summary>
    public class CsvTable<TKey> : ICsvTable
    {
        ...
        public virtual void Delete(IUpdateEntry entry)
        {
            ...
            {
                throw new DbUpdateConcurrencyException(CsvStrings.UpdateConcurrencyException, new[] { entry });
            }
        }
        ...
        protected virtual void ThrowUpdateConcurrencyException([NotNull] IUpdateEntry entry, [NotNull] Dictionary<IProperty, object> concurrencyConflicts)
        {
            ...
            if (_sensitiveLoggingEnabled)
            {
                throw new DbUpdateConcurrencyException(
                    CsvStrings.UpdateConcurrencyTokenExceptionSensitive(
            ...
            throw new DbUpdateConcurrencyException(
                CsvStrings.UpdateConcurrencyTokenException(
                    entry.EntityType.DisplayName(),
