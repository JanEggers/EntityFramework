...
namespace Microsoft.EntityFrameworkCore.Csv.Storage.Internal
{
    ...
    /// </summary>
    public class CsvTransactionManager : IDbContextTransactionManager, ITransactionEnlistmentManager
    {
        private static readonly CsvTransaction _stubTransaction = new CsvTransaction();
