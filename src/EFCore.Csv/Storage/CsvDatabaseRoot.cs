...
namespace Microsoft.EntityFrameworkCore.Storage
{
    ...
    ///     <see
    ///         cref="CsvDbContextOptionsExtensions.UseCsvDatabase{TContext}(DbContextOptionsBuilder{TContext},string,System.Action{Infrastructure.CsvDbContextOptionsBuilder})" />
    /// </summary>
    public sealed class CsvDatabaseRoot
    {
        /// <summary>
        ///     <para>
